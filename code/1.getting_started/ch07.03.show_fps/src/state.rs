...
use crate::frames::{ColorWindow, FpsWindow};
...
impl State {
    ...
    fn create_egui_platform(
        ...
        size: PhysicalSize<u32>,
        scale_factor: f64,
    ) -> (Platform, RenderPass, ColorWindow, FpsWindow) {
        ...
        let fps_window = FpsWindow::default();

        (platform, render_pass, color_window, fps_window)
    }
    ...
    pub async fn new(window: Window) -> Result<Self, Error> {
        ...
        let (egui_platform, egui_render_pass, color_window, fps_window) =
    ...
    pub fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
        ...
        // Draw the egui UI frame.
        {
            ...
            self.fps_window.ui(&self.egui_platform.context());
